...
public:
    ...
    static void createFlowMenu() {
        ...
        /// @brief Stores all the NumberInput steps entered, and is then copied to the CalculusStep
        ...
        while (true) {
            ...
            if (choice == 4) {
                ...
                NumberInputSteps.push_back(NumberInput); /// Add it to the vector
            ...
            if (choice == 5) {
                ...
                /// Here, the calculus rule will be defined
